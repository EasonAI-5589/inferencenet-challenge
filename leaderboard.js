import { ARMS, VIEWS, METRICS, DEFAULT_METRIC, DEFAULT_VIEW, validateSnapshot, rankModels, tableRows, modelDisplayName } from './leaderboard-data.js?v=20260917-metrics';
import { mountain } from './mountain.js';

const source = new URL('./assets/data/paired-results.json?v=20260917-metrics', import.meta.url);
